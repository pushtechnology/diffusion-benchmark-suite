...
public final class Histogram {
    ...
    private long observationsCount = 0L;
    ...
    public void addObservations(final Histogram histogram) {
        ...
        this.overflows += histogram.overflows;
        this.underflows += histogram.underflows;
     ...
     * top and bottom bin when calculating the mid point.
     * 
