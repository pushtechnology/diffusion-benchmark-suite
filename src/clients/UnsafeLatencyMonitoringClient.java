 ...
 *
 */
public class UnsafeLatencyMonitoringClient extends LatencyMonitoringClient {
    /**
    ...
    protected long getSentTimestamp(TopicMessage topicMessage) {
        int headerLen = EvilMessageAccessHack.getHeaderLength(topicMessage);
        ByteBuffer buffy = EvilMessageAccessHack.getBuffer(topicMessage);
